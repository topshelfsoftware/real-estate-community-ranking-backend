...
#                               --- Globals ---                               #
# ----------------------------------------------------------------------------#
from __setup__ import ALL_EVENT_FILES, ALL_EXCEL_FILES, TEST_EVENTS_PATH
FILE_DELIMITER = "_"
...
def get_test_excel_files(matching: str = None) -> list[str]:
    """Obtain all test excel files or a subset of the files
    matching the provided string."""
    subset = []
